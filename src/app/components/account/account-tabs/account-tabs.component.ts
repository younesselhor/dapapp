...
@Component({
  ...
  imports: [CommonModule, ProfileCardComponent,SavedVehiclesComponent, SettingsComponent, PaymentCardUserComponent, SoomBoxComponent],
  standalone:true,
  templateUrl: './account-tabs.component.html',
  styleUrl: './account-tabs.component.css'
})
export class AccountTabsComponent {
  tabs: string[] = ['Home', 'Settings','SOOM Box','My Ads' ,'Orders', 'Payment Information', 'Addresses', 'My Garage', 'Wishlist'];
